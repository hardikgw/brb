...
class FacebookEventsFunction(Construct):
    """Lambda that proxies the page's upcoming events from the Facebook
    Graph API, keeping the Page access token server-side."""

    CORE_NAME = "fbevents-lambda"
