...
class HolidayMarketFunction(Construct):
    """Lambda backing the Holiday Market vendor application form.

    Emails each application to the configured address via SES. Caller must
    pass the ARNs of the SES identities the function is allowed to use.
    """

    CORE_NAME = "holidaymarket-lambda"
